...
void AdcOffsetSelfCal()
{
    Uint16 AdcConvMean;
    EALLOW;
    AdcRegs.ADCCTL1.bit.ADCREFSEL = 1;                  //0-Select internal reference mode
    ...
    //AdcRegs.ADCREFTRIM.bit.EXTREF_FINE_TRIM = 0x13;
    EDIS;
}
...
// Comment out other unwanted lines.
    ...
    GpioCtrlRegs.AIODIR.bit.AIO14= 0;      // AIO14  OUTPUT
    
    GpioCtrlRegs.AIOMUX1.bit.AIO14 = 0;   // Configure AIO14 for IO output
