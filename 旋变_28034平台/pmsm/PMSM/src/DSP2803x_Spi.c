...
//  GpioCtrlRegs.GPAPUD.bit.GPIO3 = 0;    // Enable pull-up on GPIO3 
    ...
    GpioCtrlRegs.GPAPUD.bit.GPIO19 = 0;   // Enable pull-up on GPIO19 (SPISTEA)CS
...
//  GpioCtrlRegs.GPAMUX1.bit.GPIO3 = 2;  // Configure GPIO3 as SPISOMIA
	...
	GpioCtrlRegs.GPAMUX2.bit.GPIO16 = 0;  // Configure GPIO54 as GPIO
	GpioDataRegs.GPASET.bit.GPIO16 = 1;   //Set high
